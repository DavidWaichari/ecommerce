...
<body>
    ...
    <script>
        $(document).ready(function(){
            ...
            if($('.product-slider-second').length > 0) {
                $('.product-slider-second').each(function(){
                    const $slider = $(this);
                    const $prevArrow = $slider.closest('section').find('.prev-arrow');
                    const $nextArrow = $slider.closest('section').find('.next-arrow');
            ...
            // Initialize category slider with similar settings
            if($('.slider-8-columns').length > 0) {
                const $slider = $('.slider-8-columns');
                const $prevArrow = $slider.closest('section').find('.prev-arrow');
                const $nextArrow = $slider.closest('section').find('.next-arrow');
