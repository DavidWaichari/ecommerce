...
<body>
    ...
    <main>
        ...
        <section class="py-lg-16 py-10"
            style="background: url(images/banner-4.jpg) no-repeat; background-position: center; background-size: cover">
            <div class="container">
                <!-- row -->
                <div class="row">
                        ...
                        <div class="card card-product mb-lg-4">
                            <div class="card-body">
                                ...
                                <div class="text-center position-relative">
                                    ...
                                    <!-- img -->
                                    <!-- img -->
                                    <a href="#!"><img src="/theme/images/product-img-15.jpg"
                                ...
                                <h2 class="fs-6"><a href="#!"
                                        class="text-inherit text-decoration-none">Fresh Apple</a></h2>
                                <div>
                                    <!-- rating -->
                        ...
                        <div class="card card-product mb-lg-4">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    ...
                                    <!-- img -->
                                    <a href="#!"><img src="/theme/images/product-img-16.jpg"
                                            alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                                    <!-- action btn -->
                                    <!-- action btn -->
                                    <div class="card-product-action">
                    ...
                    <div class="item">
                        ...
                        <div class="card card-product mb-lg-4">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    <!-- img -->
                                    <a href="#!"><img src="/theme/images/product-img-17.jpg"
                                            alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                                    <!-- action btn -->
                                    <div class="card-product-action">
                                        <a href="#!" class="btn-action" data-bs-toggle="modal"
                                ...
                                <h2 class="fs-6"><a href="#!"
                                        class="text-inherit text-decoration-none">Fresh Kiwi</a></h2>
                                <!-- rating -->
                                <div class="text-warning">
                                    <!-- rating -->
                                    <small>
                        ...
                        <div class="card card-product mb-lg-4">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    ...
                                    <!-- img -->
                                    <a href="#!"><img src="/theme/images/product-img-18.jpg"
                                            alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                                    <!-- action btn -->
                                    <div class="card-product-action">
                                        <a href="#!" class="btn-action" data-bs-toggle="modal"
                                ...
                                <h2 class="fs-6"><a href="#!"
                                        class="text-inherit text-decoration-none">Fresh Banana</a></h2>
                                <!-- rating -->
                                <div class="text-warning">
                                    <!-- rating -->
                                    <small>
                    ...
                    <div class="item">
                        ...
                        <div class="card card-product mb-lg-4">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    <!-- img -->
                                    <a href="#!"><img src="/theme/images/product-img-19.jpg"
                                            alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                                    <!-- action btn -->
                                    <div class="card-product-action">
                                        <a href="#!" class="btn-action" data-bs-toggle="modal"
                                ...
                                <h2 class="fs-6"><a href="#!"
                                        class="text-inherit text-decoration-none">Beatroot</a></h2>
                                <!-- rating -->
                                <div class="text-warning">
                                    <!-- rating -->
                                    <small>
                    ...
                    <div class="row flex-nowrap">
                        <div class="col">
                            <div class="card border-0 card-hover">
                                <a href="#" class="img-zoom"><img src="/theme/images/ad-banner-4.jpg"
                                        alt="" class="rounded"></a>
                        ...
                        <div class="col">
                            <div class="card border-0">
                                <a href="#" class="img-zoom"><img src="/theme/images/ad-banner-5.jpg"
                                        alt="" class="rounded"></a>
                                <div
                        ...
                        <div class="col">
                            <div class="card border-0">
                                <a href="#" class="img-zoom"><img src="/theme/images/ad-banner-6.jpg"
                                        alt="" class="rounded"></a>
