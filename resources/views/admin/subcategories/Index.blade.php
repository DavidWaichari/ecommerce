            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="col-md-2">
                            <a href="/admin/sub_categories/create" type="button" class="btn btn-block btn-info btn-md">Add Sub Category</a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                            ...
                            <tbody>
                                @foreach($sub_categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/sub_categories/{{ $category->id }}/edit" class="btn btn-sm btn-primary">Edit</a>
