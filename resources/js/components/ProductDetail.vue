                            ...
                            <div class="tab-pane fade show active" id="product-tab-pane" role="tabpanel"
                                ...
                                <div class="my-8">
                                    <div class="mb-5">
                                        ...
                                        <p class="mb-0">
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nisi, tellus iaculis
                                            urna bibendum in lacus, integer. Id imperdiet vitae varius sed magnis eu nisi
                                            nunc
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <p class="mb-0">
                                            Nisi, tellus iaculis urna bibendum in lacus, integer. Id imperdiet vitae varius
                                            sed magnis eu nisi nunc sit. Vel, varius habitant ornare ac rhoncus. Consequat
                                            risus
                                            facilisis ante ipsum netus risus adipiscing sagittis sed.Lorem ipsum dolor sit
                                        ...
                                        <div class="col-md-8">
                                            <div class="mb-10">
                                                ...
                                                <div class="d-flex border-bottom pb-6 mb-6">
                                                    <!-- img -->
                                                    <!-- img -->
                                                    <img src="/theme/images/avatar-10.jpg" alt=""
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <i class="bi bi-star-fill text-warning"></i>
                                                            <i class="bi bi-star-fill text-warning"></i>
                                                            <span class="ms-3 text-dark fw-bold">Need to recheck the weight
                                                        ...
                                                        <p>
                                                            ...
                                                            FreshCart sends the veggies and fruits through sealed plastic
                                                            covers and Barcode on the weight etc. .
                                                        </p>
                                                        <div>
                                                            <div class="border icon-shape icon-lg border-2">
                                                                <!-- img -->
                                                                <img src="/theme/images/product-img-1.jpg" alt=""
                                                                    class="img-fluid">
                                                            </div>
                                                            <div class="border icon-shape icon-lg border-2 ms-1">
                                                                <!-- img -->
                                                                <img src="/theme/images/product-img-2.jpg" alt=""
                                                                    class="img-fluid">
                                                            </div>
                                                            <div class="border icon-shape icon-lg border-2 ms-1">
                                                                <!-- img -->
                                                                <img src="/theme/images/product-img-3.jpg" alt=""
                                                                    class="img-fluid">
                                                            </div>
                                                        </div>
                                                        <!-- icon -->
                                                ...
                                                <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                                    <!-- img -->
                                                    <img src="/theme/images/avatar-12.jpg" alt=""
                                                        class="rounded-circle avatar-lg">
                                                    <div class="ms-5">
                                                ...
                                                <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                                    <!-- img -->
                                                    <img src="/theme/images/avatar-9.jpg" alt=""
                                                        class="rounded-circle avatar-lg">
                                                    <div class="ms-5">
                                                        ...
                                                        <p>Everytime i ordered from fresh i got greenish yellow bananas just
                                                            like i wanted so go for it , its happens very rare that u get
                                                            over riped ones.</p>
                                                ...
                                                <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                                    <!-- img -->
                                                    <img src="/theme/images/avatar-8.jpg" alt=""
                                                        class="rounded-circle avatar-lg">
                        ...
                        <div class="card card-product">
                            <div class="card-body">
                                ...
                                <div class="text-center position-relative">
                                    ...
                                    <a href="#!">
                                        <!-- img -->
                                        <img src="/theme/images/product-img-1.jpg" alt="Grocery Ecommerce Template"
